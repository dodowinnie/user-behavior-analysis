...
public class HotItem {
    ...
    public static void main(String[] args) {
        ...
        // 读取数据
        DataStreamSource<String> stream = env.readTextFile("D:\\java\\code\\idea\\user-behavior-analysis\\hot-item-analysis\\src\\main\\resources\\UserBehavior.csv");
        // 转换数据
...
//            }
//        }));
        dataStream.keyBy(new KeySelector<UserBehavior, Long>() {
            @Override
